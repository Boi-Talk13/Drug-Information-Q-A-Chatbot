...
export default function SuggestedQuestion({ onSelectQuestion, selectedDrugName = 'RINVOQ' }) {
  const suggestions = [
    {
      type: 'indication',
      question: `What are the approved indications for ${selectedDrugName}?`,
      category: 'Indications & Uses',
      icon: BookOpen
    },
    {
      type: 'dose',
      question: `What is the recommended starting dose of ${selectedDrugName}?`,
    ...
    {
      type: 'warnings',
      question: `What boxed warnings are listed for ${selectedDrugName}?`,
      category: 'Boxed Warnings',
      icon: BookOpen
    },
    {
      type: 'advice_test',
      question: `Should I stop taking ${selectedDrugName} if my symptoms improve?`,
